...
var asciiArt = require('txt');
var bots = [a,b,c,d,e,f,g,h,i,j,l,m,n,o,p,q,r,s,t,u,v,w,x,y,z];
var port = 8080;
...
Bot.prototype = {
	...
	spawn: function() {
   var randomSkin = getRandomInt();(Buffer.from([]))
	var spawnBuf = [115,10,getRandomInt(0, 65),32,65,90,85,76,32,71,82,65,78,65,32,86,73,79,76,65,68,79, ]
 this.send(spawnBuf);
  },
	moveTo: function(x, y) {
	...
	onError: function(e) {
		...
		//console.log(e);
		setTimeout(function() {
				console.log('EL CHUPACABRAS (ARG)');
				this.connect.bind();
			}
			.bind(this), 5);
	},
...
//asciiArt.font('arg manda', 'Doom', function(rendered){
